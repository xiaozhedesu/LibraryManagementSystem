...
public class SearchPage extends JPanel {
    ...
    private JComboBox<String> createSelectBox() {
        ...
        select.setModel(new DefaultComboBoxModel<>(MODES));
        return select;
    }
    ...
    private JTextField createInputArea() {
        ...
        input.addActionListener(e -> updateTable(OPS[select.getSelectedIndex()], input.getText()));
        return input;
    }
    ...
    private JButton createSubmitButton() {
        ...
        submit.addActionListener(e -> updateTable(OPS[select.getSelectedIndex()], input.getText()));
        return submit;
    }
